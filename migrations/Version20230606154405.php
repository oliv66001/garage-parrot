 ...
 */
final class Version20230606154405 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, brand VARCHAR(150) NOT NULL, description LONGTEXT DEFAULT NULL, image VARCHAR(255) NOT NULL, kilometer INT NOT NULL, price INT NOT NULL, year DATE NOT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_1B80E486BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
